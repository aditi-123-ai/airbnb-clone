        ...
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
            ...
            {searchInput && (
                <div className="flex flex-col col-span-3 mx-auto mt-10">
                    ...
                    <div className="flex">
                        <button onClick={resetInput} className="flex-grow text-gray-500 cursor-pointer">Cancle</button>
                        <button onClick={search} className="flex-grow text-red-400 cursor-pointer">Search</button>
                    </div>
                </div>
            )}
        </header>
